    ...
    <header className="sticky top-0 z-30 flex h-14 items-center gap-2 sm:gap-4 border-b border-border bg-background/80 px-3 sm:px-4 backdrop-blur-sm" role="banner">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        >
          ...
          <kbd className="pointer-events-none hidden h-5 select-none items-center gap-1 rounded border border-border bg-muted px-1.5 font-mono text-xs font-medium text-muted-foreground sm:flex">
            ⌘K
          </kbd>
        </button>
      </div>
