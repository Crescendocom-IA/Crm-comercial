-- ============================================================
-- FlowCRM — Initial Schema
-- ============================================================
-- Migration única, gerada a partir do schema consolidado do projeto
-- original e completada com os objetos que faltavam nele (ver o bloco
-- "COMPLEMENTOS" no final do arquivo).
-- ============================================================
-- ============================================================
...
-- COMPLEMENTOS
-- ------------------------------------------------------------
-- Objetos presentes nas migrations originais mas ausentes do
-- consolidated_schema.sql. Sem eles o schema fica incompleto:
-- o aceite de convites nunca é registrado e o CRM perde os
-- índices das colunas mais filtradas.
-- ============================================================

-- Marca o convite como aceito quando o profile do convidado é criado.
-- Origem: 20260331174047_9b40957d-1cf4-471c-a166-b721b9514d0b.sql
...
DROP TRIGGER IF EXISTS on_profile_created_mark_invite ON public.profiles;
CREATE TRIGGER on_profile_created_mark_invite
  AFTER INSERT ON public.profiles
  FOR EACH ROW
  EXECUTE FUNCTION public.mark_invitation_accepted();

-- Índices de performance nas colunas mais filtradas (org_id, FKs, status).
